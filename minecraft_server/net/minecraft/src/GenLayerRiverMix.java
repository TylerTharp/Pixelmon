...
public class GenLayerRiverMix extends GenLayer
{
    ...
    {
        super(par1);
        this.field_35033_b = par3GenLayer;
        this.field_35034_c = par4GenLayer;
    }
    ...
    {
        this.field_35033_b.initWorldGenSeed(par1);
        this.field_35034_c.initWorldGenSeed(par1);
    ...
    {
        int[] var5 = this.field_35033_b.getInts(par1, par2, par3, par4);
        int[] var6 = this.field_35034_c.getInts(par1, par2, par3, par4);
