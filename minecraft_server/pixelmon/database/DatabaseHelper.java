...
public class DatabaseHelper
{
	...
	public static boolean has()
	{
		try
		{
			...
			Connection c = DriverManager.getConnection("jdbc:sqlite:" + FMLServerHandler.instance().getMinecraftRootDirectory() + "/database/pixelmon.db");
			if (c ==null){
				System.out.println("Could not find Database at " + FMLServerHandler.instance().getMinecraftRootDirectory() + "/database/pixelmon.db");
				return false;
			}else{
				System.out.println("Found Database at " + FMLServerHandler.instance().getMinecraftRootDirectory() + "/database/pixelmon.db");
			}
			return true;
	...
	public static Connection getConnection()
	{
		...
		{
			Class.forName("org.sqlite.JDBC");
			Connection con = DriverManager.getConnection("jdbc:sqlite:" + FMLServerHandler.instance().getMinecraftRootDirectory() + "/database/pixelmon.db");
