...
public class FMLClientHandler implements IFMLSidedHandler
{
    ...
    public void onPreWorldTick()
    {
        if (client.theWorld != null) {
            ...
            FMLCommonHandler.instance().tickStart(EnumSet.of(TickType.WORLD,TickType.GAME,TickType.WORLDGUI), 0.0f, client.currentScreen, client.theWorld);
        }
    }
    ...
    public void onPostWorldTick()
    {
        if (client.theWorld != null) {
            // For the client world ticks and game ticks are the same
            FMLCommonHandler.instance().tickEnd(EnumSet.of(TickType.WORLD,TickType.GAME,TickType.WORLDGUI), 0.0f, client.currentScreen, client.theWorld);
        }
